...
func buildPrompt(userPrompt string, predictableKeys []KeyDef) string {
	...
	b.WriteString("- Bold/italic/underline from <w:b/>, <w:i/>, <w:u/> must map to <b>, <i>, <u> INLINE tags (inside <p>). Paragraph alignment from <w:jc> maps to <w:c> BLOCK tag. When a paragraph has BOTH alignment AND bold/italic/underline, use combined block syntax: <w:c|b>Center Bold</w:c|b>, NOT nested <w:c><b>Center Bold</b></w:c>. Valid combinations: <w:c|b>, <w:b|i>, <w:b|i|u>, <w:c|b|i>.\n")
